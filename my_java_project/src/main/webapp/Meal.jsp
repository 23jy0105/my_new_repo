...
<body class="background">
    ...
    <div class="container3">
        <div class="container-block">
            <h1>朝食</h1>
            <p><img src="./img/meal_morning.png"max-width="600px" width="90%" alt="朝食の画像"></p>
            <p>和朝食炊き立てのご飯に焼きたての旬魚。副菜と味噌汁の定番の朝食です。</p>
        </div>
        <div class="container-block">
            <h1>夕食</h1>
            <p><img src="./img/meal_dinner01.png"max-width="600px" width="90%" alt="夕食の画像"></p>
            <p>地元の魚や野菜を使ったおいしいお食事をご用意しております。<br>
            また、季節の食材を使った期間限定のお食事もごさいます。<br>
            料理人が選ぶその時期ならではの食材をお召し上がりいただきます。</p>
        </div>
    </div>
</div>
<footer>
